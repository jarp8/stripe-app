...
class Card {
    ...
    factory Card.fromMap(Map<String, dynamic> json) => Card(
        installments: json["installments"] == null ? null : Installments.fromMap(json["installments"]),
...
class Installments {
    ...
    factory Installments.fromMap(Map<String, dynamic> json) => Installments(
        availablePlans: json["available_plans"] == null ? [] : List<dynamic>.from(json["available_plans"]!.map((x) => x)),
        enabled: json["enabled"],
        plan: json["plan"],
    );

    Map<String, dynamic> toMap() => {
        "available_plans": availablePlans == null ? [] : List<dynamic>.from(availablePlans!.map((x) => x)),
        "enabled": enabled,
        "plan": plan,
    };
}
